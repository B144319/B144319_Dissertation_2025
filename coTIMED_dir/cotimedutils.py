__version__ = "0.1.2"
#By Handing Wang, Wells-Wood-Research 
import pandas as pd
import json
import pathlib
import os
...
def get_double_chain(pdb_path: str, ) -> str:
    """
    ...
    # extract the sequence from the list and convert it to a string
    fasta_seq = sequences[0] + sequences[1]
...
def do_seq_design_pipeline(protein_name: str,pdb_path: str,cutoff) -> list:
    ...
    probabilities_path = '/home/s_alya/research_project/chosen_prots_timed/4dri/pose_5/CoTIMED.csv'
    label_map_path = '/home/s_alya/research_project/chosen_prots_timed/4dri/pose_5/datasetmap.txt'
    ...
    for key_full_name in redesign_sequence.keys():
        ...
        for item_idx in redesign_sequence[key_full_name]:
            ...
            predict_seq[key_full_name][item_idx] = get_amino_acid(key_full_name, int(item_idx), df_prob, cutoff=0.5)
...
if __name__ == "__main__":
    ...
    prot_name = "/home/s_alya/research_project/chosen_prots_timed/4dri/pose_5/4dri_pose5_corrected" # adjust the name of protein
