...
def process_one_protein(file_name):
    ...
    try:
        basename = file_name
        pdb_path = f'/home/s_alya/research_project/Boltz2_results/4dri_results/boltz_results_{basename}/predictions/{basename}/{basename}_model_0_protein.pdb'
        ...
        pdb_predict_prefix = re.sub(r'_\d+$', '', basename)

        redesign_path = f'/home/s_alya/research_project/chosen_prots_timed/4dri/pose_{pose_number}/{pdb_predict_prefix}_predict_prob.csv'
...
if __name__ == "__main__":
    df_culling = pd.read_csv('/home/s_alya/research_project/Boltz_scores_culled_4dri_preIE.csv')
    filenames = df_culling['name'].tolist()
